...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
		...
		function handleScroll(e) {
			var yOffset = (0, _jquery2.default)(window).scrollTop();
			var megaMenus = (0, _jquery2.default)('.js-mega-menu');
	
			_jquery2.default.each(megaMenus, function (elem) {
				(0, _jquery2.default)(elem).css('transform', 'translateY(' + (yOffset + 15) + 'px)');
			});
		}
...
//# sourceMappingURL=0.1cc9f7f63b4404afb8c5.hot-update.js.map