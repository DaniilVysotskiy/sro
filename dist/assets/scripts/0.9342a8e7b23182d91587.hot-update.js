	...
	(0, _jquery2.default)(function () {
		...
		function initJsDropdown() {
			(0, _jquery2.default)('[data-item="dropdown"]').on('click', function (e) {
				...
				(0, _jquery2.default)(target).toggle(300);
			});
		}
	
		function initTabs() {
			(0, _jquery2.default)('.tabs__tab').on('click', function (e) {
				e.preventDefault();
				var link = (0, _jquery2.default)(this).attr('href');
	
				(0, _jquery2.default)(this).addClass('active').siblings().removeClass('active');
				(0, _jquery2.default)(link).addClass('active').siblings().removeClass('active');
			});
		}
	
		function initFoldingMenu() {
			(0, _jquery2.default)('.menu__fold').on('click', function () {
				(0, _jquery2.default)(this).toggleClass('active').siblings().removeClass('active');
			});
		}
...
//# sourceMappingURL=0.9342a8e7b23182d91587.hot-update.js.map